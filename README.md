...
HotPlate Online is a simple program that allows customers to order food online and have it delivered. At the moment, this program only works for Windows operating systems, but there are plans to expand to Android, IOS and MacOS. Hotplate Online Restaurant was created by Andrew Collin (<a href = https://github.com/AndrewCollin32> Link </a>) 
